...
class OutputGrabber(object):
    ...
    def readOutput(self):
        ...
        """
        while True:
            char = os.read(self.pipe_out, 1).decode('ascii')
...
print("1 I'm printing from python in capture")
directfdprint(b"2 I'm printing from libc in capture\n")
...
print('Captured text: ', out.capturedtext, 'XX')
